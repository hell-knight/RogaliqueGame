...
TEST(VectorTests, VectorPlusVector) {
	...
	EXPECT_EQ(third.x, 0.f);
	EXPECT_EQ(third.y, 6.f);
}
...
TEST(VectorTests, VectorMinusVector) {
	...
	EXPECT_EQ(third.x, 8.f);
	EXPECT_EQ(third.y, -12.f);
}
...
TEST(VectorTests, NegativeVector) {
	...
	EXPECT_EQ(second.x, -4.f);
	EXPECT_EQ(second.y, 3.f);
}
...
TEST(VectorTests, VectorMultiplyVector) {
	...
	EXPECT_EQ(third.x, -16.f);
	EXPECT_EQ(third.y, -27.f);
}
